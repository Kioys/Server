...
namespace Server
{
    //la clase Client maneja un socket por separado, asi se pueden manejar multiples clientes al mismo tiempo sin generar errores
    //cada Client manejara un metodo asyncronico que se llama readCallback, (llamar Client.readCallback al usar metodo BeginReceive)
    public class Client
    {
